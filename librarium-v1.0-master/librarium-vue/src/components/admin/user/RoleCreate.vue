<template>
  <div style="text-align: left">
    <el-button class="add-button el-icon-folder-add" type="success" @click="dialogFormVisible = true">添加角色</el-button>
    <el-dialog
      title="添加角色"
      ...
      <el-form :model="roleForm" :rules="rules" label-position="left"
        ...
        <el-form-item style="width: 100%">
          <el-button type="primary" style="width: 40%;border: none; margin-left: 80px" v-on:click="createRole" class="el-icon-plus">添加</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
